...
/// Maximum snake length before any apples have been eaten
pub(crate) const INITIAL_SNAKE_LENGTH: usize = 3;

/// How many cells the snake's length should increase by upon eating an apple
...
pub(crate) const APPLE_SYMBOL: char = '\u{25CF}';
